<template>
  <div class="w-screen h-full pt-12 bg-baytLightGreen absolute">
    <iframe
    ...
    <div class="grid grid-cols-2 gap-4 mx-4 relative">
      <div
    ...
    <div class="bg-baytDarkestGreen absolute p-3 rounded-xl bottom-0 m-3">
